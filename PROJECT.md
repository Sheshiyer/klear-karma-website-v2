...
This is the canonical project entry point for the `klear-karma-website-v2`
...
- Registry WorkObject: `sapling:klear-karma` (`Klear Karma`, kind: sapling)
- GitHub: `Sheshiyer/klear-karma-website-v2` (identity_status: pending-teamforge-verification)
...
`true` is the current deterministic verification
command.
